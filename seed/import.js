...
async function importSiteConfig() {
  ...
  const configs = [
    ...
    { key: 'dog_bio', value: '海巴是你的第一条狗狗，是最爱你的狗狗，小小的脑袋里面只有爱你，他虽然永远的离开了你，但是你会得到更多的爱，我会像海巴一样所有的爱只为了你一个人。' },
    { key: 'dog_birthday', value: new Date('2023-03-15') },
    { key: 'about_title', value: '关于我们' },
    { key: 'about_content', value: '这里记录的是我们两个人的日常。\n\n生活不总是波澜壮阔，更多的是平凡日子里的小确幸——一起做饭的假期、牵手散步的午后、窝在床上看电影的夜晚。\n\n每一个瞬间都值得被记住，每一个平凡的日子都闪着光。\n\n感谢你出现在我的生命里，让普通的日子变得不再普通。' },
    { key: 'about_images', value: [] },
    { key: 'anniversary_date', value: new Date('2025-06-06') },
